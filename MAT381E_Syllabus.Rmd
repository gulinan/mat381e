...
We will be using `R` programming language with `RStudio IDE` for data related works.
You will be using the version control system `Git` along with `GitHub` to submit homework assignments and
...
| **Week** | **Date**   | **Topic**  | 
| :---:| :---: | :-----------| 
| 1 | 04/10 | Introduction to data science and computational tools.| **(Project proposal assigned)**|
...
| 5 | 01/11 | Handling with strings and dates in data. **(HW1 assigned, Project proposal submission)**|
| 6 | 08/11 | Scraping data from web.|
| 7 | 15/11 | Data extraction from social networking sites. |
| 8 | 22/11 | ITU Fall Break. |
| 9 | 29/11 | Basic principles of text mining. **(Project interim report submission)**|
...
2.	Bivand, R.S., Pebesma, E.J., Gomez-Rubio, V., and Pebesma, E. J. (2013). Applied spatial data analysis with R. New York: Springer. 2nd ed. [Electronic resource at ITU Library Services].
...
- Peer evaluation and statement of personal contribution forms will be available on Ninova.

- **For detailed information on project design guideline, please see the relevant document on Ninova.** 

- **Every study mentioned above should be submitted by each student via Ninova and GitHub Classroom of MAT381E-Fall21 organization.**
...
**Final Exam Attendance Policy:** At least 30 points from in-semester studies.
...
is deemed responsible to manage his/her absences.
