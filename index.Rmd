...
team-based works through `GitHub classroom` of our course. You will publish your final project on `GitHub pages`. Lastly, prior knowledge of `HTML`, `CSS`, and `JavaScript` brings a big plus to produce fancy outputs for your works. But it is neither a must nor focus of this course.
...
| :---:    | :---:      |:---------------------|:------:|:-----:
| 1 | 04/10 | Introduction to data science and computational tools. **(Project proposal assigned)** |  [🔗](https://github.com/MAT381E-Fall21/Week_01_02_Lecture_Notes) [🔗](https://github.com/MAT381E-Fall21/Project_Proposal) | 
...
| 5 | 01/11 | Handling with strings and dates in data. **(HW1 assigned, Project proposal submission)**| [🔗](https://github.com/MAT381E-Fall21/Week_07_Lecture_Notes) [🔗](https://github.com/MAT381E-Fall21/Homework_I) [🔗](https://github.com/MAT381E-Fall21/project_interim_report)|
| 6 | 08/11 | Scraping data from web.| [🔗](https://github.com/MAT381E-Fall21/Week_08_Lecture_Notes)|
| 7 | 15/11 | Data extraction from social networking sites. | [🔗](https://github.com/MAT381E-Fall21/Week_09_Lecture_Notes)|
| 8 | 22/11 | ITU Fall Break. ||
| 9 | 29/11 | Basic principles of text mining.| |
| 10 | 06/12 | Network analysis and visualization.| [🔗](https://github.com/MAT381E-Fall21/Week_10_Lecture_Notes)|
| 11 | 13/12 | Basic principles of geographic information system.|[`Slides`](https://mat381e-fall21.github.io/Week_11_12_Lecture_Notes/#1), [🔗](https://github.com/MAT381E-Fall21/Week_11_12_Lecture_Notes) |
| 12 | 20/12 | Visualization of spatial and urban data. **(Project interim report submission)**| |
| 13 | 27/12 | Basic principles of interactive data visualization. **(HW2 assigned)**|  [🔗](https://github.com/MAT381E-Fall21/Homework_II)|
| 14 | 03/01 | Interactive web-based data visualization tools.| [🔗](https://github.com/MAT381E-Fall21/Week_13_14_Lecture_Notes)  |
| 15 | 10/01| Relational databases. | |
| 16-17 | 17-30/01| Final exam week. **(Final report submission, Oral presentation, Project website on GitHub pages, Peer Evaluation)** |[🔗](https://github.com/MAT381E-Fall21/Project_final_report) [🔗](https://github.com/MAT381E-Fall21/Peer_evaluation)|
...
7. Baumer, B.S., Kaplan, D.T., and Horton, N.J. (2021). Modern data science with R. 
[Freely available through the book’s website https://mdsr-book.github.io/mdsr2e/]. 
...
This course could not be possible without [ITU-Zoom](https://itu-edu-tr.zoom.us/), [ITU-Ninova](https://ninova.itu.edu.tr/tr/), [RStudio](https://www.rstudio.com/) along with all open-source packages, [GitHub](https://github.com/), [GitHub Classroom](https://classroom.github.com/) and generous support of [DataCamp](https://www.datacamp.com/). 
The course slides are prepared with [R xaringan](https://github.com/yihui/xaringan) along with
[R xaringan extra](https://github.com/gadenbuie/xaringanExtra). The course web site is built on [Distill for R Markdown](https://rstudio.github.io/distill/) and hosted at [GitHub pages](https://pages.github.com/).
